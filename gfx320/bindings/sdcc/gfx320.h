...
typedef struct {
    const gfx320_tile_item_t *items;
    gfx_u16 count;
...
void gfx320_bind(gfx_u8 handle);
...
gfx_u8 gfx320_copy_rect(const gfx320_copy_rect_t *rect);
gfx_u8 gfx320_copy_buffer(gfx_u8 source, gfx_u8 destination_flags);
gfx_u8 gfx320_restore_rect(const gfx320_restore_rect_t *rect);
...
gfx_u8 gfx320_draw_tile_span(const gfx320_tile_span_t *span);
gfx_u8 gfx320_draw_tile_list(const gfx320_tile_list_t *list);
gfx_u8 gfx320_draw_tilemap(const gfx320_tilemap_t *map);
gfx_u8 gfx320_draw_metatile(const gfx320_metatile_t *metatile);
gfx_u8 gfx320_draw_rect(const gfx320_rect_t *rect);
...
gfx_u8 gfx320_line(const gfx320_line_t *line);
gfx_u8 gfx320_move_rect(const gfx320_copy_rect_t *rect);
gfx_u8 gfx320_scroll_rect(const gfx320_scroll_rect_t *rect);
